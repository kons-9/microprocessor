...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins cpu_0/sysclk]
  connect_bd_net -net cpu_0_uart_tx [get_bd_ports uart_tx] [get_bd_pins cpu_0/uart_tx]
  connect_bd_net -net cpu_resetn_1 [get_bd_ports cpu_resetn] [get_bd_pins cpu_0/cpu_resetn]
