...
#
# Generated by Vivado on Tue Nov 17 00:41:18 JST 2020
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../cpu_single.srcs/sources_1/bd/design_1/ipshared/8b3d" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../cpu_single.srcs/sources_1/bd/design_1/ipshared/8b3d" \
    ...
    "$ref_dir/../../../bd/design_1/ip/design_1_cpu_0_0/sim/design_1_cpu_0_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/denjo/risc/work/cpu_single/cpu_single.cache/compile_simlib/vcs"
  fi
